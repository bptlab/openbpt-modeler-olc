...
export default class CustomPaletteProvider {
  ...
  getPaletteEntries(element) {
    ...
    assign(actions, {
      ...
      "create-initial-state": createAction(
        `${MODELER_PREFIX}:InitialState`,
        "custom-elements",
        generatedIcons["olc-initial-state"],
        translate("Create initial state"),
      ),
      ...
      "create-final-state": createAction(
        `${MODELER_PREFIX}:FinalState`,
        "custom-elements",
        generatedIcons["olc-final-state"],
        translate("Create final state"),
      ),
    });
    return actions;
  }
